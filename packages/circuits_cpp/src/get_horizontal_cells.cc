...
CellDatas5 get_horizontal_cells(
  ...
  if ((query_coord.x != player_coord.x) || invalid_coord_y(player_coord, query_coord)) {
  ...
  query_coords[0].x = player_coord.x - 2; query_coords[0].y = player_coord.y;
  query_coords[1].x = player_coord.x - 1; query_coords[1].y = player_coord.y;
  ...
  query_coords[4].x = player_coord.x + 2; query_coords[4].y = player_coord.y;
